...
function silver_hubs_services_setting( $wp_customize ) {
	...
	//OUR SERVICES
		...
		//Our services Section Pro Link
			$wp_customize->add_setting('our_services_slider_pro', array(
		        'type'       => 'theme_mod',
		        'transport'   => 'refresh',
		        'capability'     => 'edit_theme_options',
		        'sanitize_callback' => 'sanitize_text_field',
		    ...
		    $wp_customize->add_control( new silver_hubs_pro_option_Control(
		    	$wp_customize,'our_services_slider_pro',
		    	array(
			        'settings' => 'our_services_slider_pro',

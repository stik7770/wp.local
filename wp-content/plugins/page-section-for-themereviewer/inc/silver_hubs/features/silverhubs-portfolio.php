...
function silver_hubs_portfolio_setting( $wp_customize ) {
	...
	//Our Portfolio
		...
		//Our Portfolio Section Pro Link
			$wp_customize->add_setting('our_portfolio_slider_pro', array(
		        'type'       => 'theme_mod',
		        'transport'   => 'refresh',
		        'capability'     => 'edit_theme_options',
		        'sanitize_callback' => 'sanitize_text_field',
		    ...
		    $wp_customize->add_control( new silver_hubs_pro_option_Control(
		    	$wp_customize,'our_portfolio_slider_pro',
		    	array(
			        'settings' => 'our_portfolio_slider_pro',

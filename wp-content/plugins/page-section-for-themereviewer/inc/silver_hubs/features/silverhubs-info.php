	...
	//Featured Section
	    ...
	    //Featured Slider in number of slides
			...
			$about_number = get_theme_mod( 'featured_section_number', 3 );
				...
				//Featured Section Pro Link
					$wp_customize->add_setting('featured_section_slider_pro', array(
				        'type'       => 'theme_mod',
				        'transport'   => 'refresh',
				        'capability'     => 'edit_theme_options',
				        'sanitize_callback' => 'sanitize_text_field',
				    ...
				    $wp_customize->add_control( new silver_hubs_pro_option_Control(
				    	$wp_customize,'featured_section_slider_pro',
				    	array(
					        'settings' => 'featured_section_slider_pro',

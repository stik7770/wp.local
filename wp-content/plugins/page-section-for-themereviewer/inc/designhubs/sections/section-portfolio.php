<?php
if ( ! function_exists( 'designhubs_section_portfolio_activate' ) ) :
	function designhubs_section_portfolio_activate(){
		$sections = array();
		$portfolios = apply_filters('designhubs_section', $sections);

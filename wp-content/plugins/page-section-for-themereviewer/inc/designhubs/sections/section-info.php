<?php
if ( ! function_exists( 'designhubs_section_info_activate' ) ) :
	function designhubs_section_info_activate(){
		$sections = array();
		$featured_section = apply_filters('designhubs_section', $sections);

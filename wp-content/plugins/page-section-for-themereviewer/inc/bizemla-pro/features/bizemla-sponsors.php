...
function bizemla_sponsors_setting( $wp_customize ) {
	$sections = array();
	$sponsors = apply_filters('bizemla_pro_section', $sections);
	//Our Sponsors
		$wp_customize->add_section( 'bizemla_our_sponsors_section' , array(
			'title'  => 'Our Sponsors',
		...
		//Our Sponsors in Tabing
	        ...
	        $wp_customize->add_control( new bizemla_Custom_Radio_Control( 
		        $wp_customize,'our_sponsors_tab',array(
		            ...
		            'priority'   => 10,
		            'section'    => 'bizemla_our_sponsors_section',
		            'type'    => 'select',
		            'choices'    => array(
			        	'general' => 'General',
			        	'design' => 'Design',
		...
		//Our Sponsors in Title
			...
			$wp_customize->add_control( new WP_Customize_Control(
		    	...
		    	array(
					...
					'section' => 'bizemla_our_sponsors_section', // // Add a default or your own section
					'label' => 'Our Sponsors Title', 
					'active_callback' => 'bizemla_our_sponsors_general_callback',     
				)
			) );
			if ( isset( $wp_customize->selective_refresh ) ) {
				$wp_customize->selective_refresh->add_partial(
					...
					array(
						...
						'render_callback' => 'bizemla_customize_partial_sponsors',
					)
				);
			}
		...
		//Our Sponsors in number of section
			...
			$wp_customize->add_control( new WP_Customize_Control(
		    	...
		    	array(
					...
					'section' => 'bizemla_our_sponsors_section', // // Add a default or your own section
					'label' => 'No of Section',
					'description' => 'Save and refresh the page if No. of Section is changed (Max no of section is 10)',
					'input_attrs' => array(
								    'min' => 1,
								    'max' => 10,
								),
		...
		$our_sponsors_number = get_theme_mod( 'our_sponsors_number', 5 );
			...
			//Our sponsors in Text color
		        ...
		        $wp_customize->add_control( new WP_Customize_Color_Control( 
			        ...
			        array(
			            ...
			            'priority'   => 10,
			            'section'    => 'bizemla_our_sponsors_section',   
			            'active_callback' => 'bizemla_our_sponsors_design_callback',
			        ) 
		        ) ); 
		    ...
		    //Our sponsors in image hover background color
		        ...
		        $wp_customize->add_control( new WP_Customize_Color_Control( 
			        ...
			        array(
			            'label'      => __( 'Image Hover Background Color', 'bizemla' ), 
		    ...
		    //Our sponsors in arrow text color
				$wp_customize->add_setting( 'our_sponsors_arrow_text_color', 
			        array(
		        ...
		        $wp_customize->add_control( new bizemla_Customize_Transparent_Color_Control( 
			        $wp_customize,'our_sponsors_arrow_text_color', 
			        array(
			            'label'      => __( 'Arrow Text Color', 'bizemla' ), 
			            'settings'   => 'our_sponsors_arrow_text_color', 
			            'priority'   => 10,
			            'section'    => 'bizemla_our_sponsors_section',
			            'active_callback' => 'bizemla_our_sponsors_design_callback',
			        ) 
		    ...
		    //Our sponsors in arrow text hover color
				$wp_customize->add_setting( 'our_sponsors_arrow_text_hover_color', 
			        array(
			            'default'    => '#168686', //Default setting/value to save
			            'type'       => 'theme_mod',
			            'transport'   => 'refresh',
		        ...
		        $wp_customize->add_control( new bizemla_Customize_Transparent_Color_Control( 
			        $wp_customize,'our_sponsors_arrow_text_hover_color', 
			        array(
		    ...
		    //Our sponsors in arrow background hover color
				$wp_customize->add_setting( 'our_sponsors_arrow_bg_hover_color', 
			        array(
			            'default'    => '#ffffff', //Default setting/value to save
			            'type'       => 'theme_mod',
			            'transport'   => 'refresh',
		        ...
		        $wp_customize->add_control( new bizemla_Customize_Transparent_Color_Control( 
			        $wp_customize,'our_sponsors_arrow_bg_hover_color', 
			        array(
			            'label'      => __( 'Arrow Background Hover Color', 'bizemla' ), 
			            'settings'   => 'our_sponsors_arrow_bg_hover_color', 
			            'priority'   => 10,
			            'section'    => 'bizemla_our_sponsors_section',
			            'active_callback' => 'bizemla_our_sponsors_design_callback',
			        ) 
...
add_action( 'customize_register', 'bizemla_sponsors_setting' );

function bizemla_our_sponsors_general_callback(){
...
function bizemla_our_sponsors_design_callback(){

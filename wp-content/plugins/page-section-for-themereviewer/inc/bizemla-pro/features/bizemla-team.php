<?php
function bizemla_team_setting( $wp_customize ) {
	$sections = array();
	$teams = apply_filters('bizemla_pro_section', $sections);
	...
	//Our Team
		$wp_customize->add_section( 'bizemla_our_team_section' , array(
			'title'  => 'Our Team',
		...
		//Our Team tabing 
	        ...
	        $wp_customize->add_control( new bizemla_Custom_Radio_Control( 
		        $wp_customize,'our_team_section_tab',array(
		            ...
		            'priority'   => 10,
		            'section'    => 'bizemla_our_team_section',
		            'type'    => 'select',
		            'choices'    => array(
			        	'general' => 'General',
			        	'design' => 'Design',
		...
		//Our Team in Title
			...
			$wp_customize->add_control( new WP_Customize_Control(
		    	...
		    	array(
					...
					'section' => 'bizemla_our_team_section', // // Add a default or your own section
					'label' => 'Our Team Title',
					'active_callback' => 'bizemla_our_team_general_callback',
				)
			) );
			if ( isset( $wp_customize->selective_refresh ) ) {
				$wp_customize->selective_refresh->add_partial(
					...
					array(
						...
						'render_callback' => 'bizemla_customize_partial_our_team',
					)
				);
			}
		...
		//Our Team in number of section
			...
			$our_team_number = get_theme_mod( 'our_team_number', 6 );
		...
		//Our Team Section in Background Title
		    ...
		    $wp_customize->add_control( new bizemla_GeneratePress_Upsell_Section(
		    	...
		    	array(
			        ...
			        'active_callback' => 'bizemla_our_team_design_callback',
		        )
		    ));
			...
			//Our Team in Background Position
			    $wp_customize->add_setting('bizemla_our_team_bg_position', array(
			    ...
			    $wp_customize->add_control( new WP_Customize_Control(
			    	$wp_customize,'bizemla_our_team_bg_position',
			    	array(
				        'settings' => 'bizemla_our_team_bg_position',
			...
			//Our Team Section in Background Attachment
				$wp_customize->add_setting('bizemla_our_team_bg_attachment', array(
			        'default'        => 'scroll',
			        'type'       => 'theme_mod',
			        'transport'   => 'refresh',
			        'capability'     => 'edit_theme_options',		
			    ...
			    $wp_customize->add_control( new WP_Customize_Control(
			    	$wp_customize,'bizemla_our_team_bg_attachment',
			    	array(
				        'settings' => 'bizemla_our_team_bg_attachment',
			...
			//Our Team Section in image background Size
			    $wp_customize->add_setting('bizemla_our_team_bg_size', array(
			        'default'        => 'cover',
			        'type'       => 'theme_mod',
			        'transport'   => 'refresh',
			        'capability'     => 'edit_theme_options',		
			    ...
			    $wp_customize->add_control( new WP_Customize_Control(
			    	$wp_customize,'bizemla_our_team_bg_size',
			    	array(
				        'settings' => 'bizemla_our_team_bg_size',
	    ...
	    //Our team container background Hover color
			$wp_customize->add_setting( 'our_team_container_bg_hover_color', 
		        array(
	        ...
	        $wp_customize->add_control( new WP_Customize_Color_Control( 
		        $wp_customize,'our_team_container_bg_hover_color', 
		        array(
		            'label'      => __( 'Container Background Hover Color', 'bizemla' ), 
		            'settings'   => 'our_team_container_bg_hover_color', 
		            'priority'   => 10,
		            'section'    => 'bizemla_our_team_section',
		            'active_callback' => 'bizemla_our_team_design_callback',
		        ) 
	    ...
	    //Our team text hover color
	        ...
	        $wp_customize->add_control( new WP_Customize_Color_Control( 
		        ...
		        array(
		            'label'      => __( 'hover on Text Color', 'bizemla' ), 
	    ...
	    //Our team Link Hover color
			$wp_customize->add_setting( 'our_team_link_hover_color', 
		        array(
		            'default'    => '#04ffd2', //Default setting/value to save
		            'type'       => 'theme_mod',
		            'transport'   => 'refresh',
		            'capability' => 'edit_theme_options',
		            'sanitize_callback' => 'sanitize_hex_color',
	    ...
	    //Our team icon background hover color
	        ...
	        $wp_customize->add_control( new WP_Customize_Color_Control( 
		        ...
		        array(
		            'label'      => __( 'Icon Background Hover Color', 'bizemla' ), 
...
add_action( 'customize_register', 'bizemla_team_setting' );

function bizemla_our_team_general_callback(){
...
function bizemla_our_team_design_callback(){

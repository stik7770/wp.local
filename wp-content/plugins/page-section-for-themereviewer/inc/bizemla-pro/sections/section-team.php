<?php
if ( ! function_exists( 'bizemla_team_activate' ) ) :
	function bizemla_team_activate(){
		$quantity  = get_theme_mod( 'our_team_number', 6 );
		$sections = array();
								...
								<div class="our_teams_contain">
									<div class="our_team_title">
										<a href="<?php echo esc_html(get_theme_mod( 'our_team_title_link_'.$i ,'#' )); ?>">
											<h3><?php echo esc_html(get_theme_mod( 'our_team_title_'.$i, $teams['team']['title'][$i-1] )); ?></h3>
										</a>
									</div>

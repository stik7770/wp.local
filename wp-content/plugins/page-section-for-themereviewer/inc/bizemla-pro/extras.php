<?php 
function bizemla_pro_section_data($sections){
    $sections = array(
	    		'slider' =>	array(
	    		...
	    		'team' => array(
	    				'description' => 'Magnam Dolores Commodi Suscipit. Necessitatibus Eius Consequatur Ex Aliquid Fuga Eum Quidem. Sit Sint Consectetur Velit. Quisquam Quos Quisquam Cupiditate. Et Nemo Qui Impedit Suscipit Alias Ea.',
	    				'title'    => array('Steven Lucy','Glenn Maxwell','Aaron Finch', 'Christiana Ena','Glenn Maxwell','Steven Lucy'),
	    				'headline' => array('Executive','Project Manager','Manager And Director', 'Executive','Project Manager','Executive'),
	    			),
	    		'testimonial' => array(
	    			'description' => 'Magnam Dolores Commodi Suscipit. Necessitatibus Eius Consequatur Ex Aliquid Fuga Eum Quidem. Sit Sint Consectetur Velit. Quisquam Quos Quisquam Cupiditate. Et Nemo Qui Impedit Suscipit Alias Ea.',
...
add_filter( 'bizemla_pro_section', 'bizemla_pro_section_data');

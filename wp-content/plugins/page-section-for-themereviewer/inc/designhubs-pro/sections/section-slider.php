			...
			<div class="featured_slider_image">
				<div id="owl-demo" class="owl-carousel owl-theme featuredimage_slider">
					...
					for ( $i = 1; $i <= $quantity; $i++ ) {
						if($i <= 4){
							$designhubs_post_title = get_theme_mod( 'featuredimage_slider_title_' . $i, $sliders['slider']['title'][$i-1]);
							$designhubs_image_slider_description = get_theme_mod( 'featuredimage_slider_description_' . $i, $sliders['slider']['description'][$i-1] );
						...
						<?php }else{
							$designhubs_post_title = get_theme_mod( 'featuredimage_slider_title_' . $i);
							$designhubs_image_slider_description = get_theme_mod( 'featuredimage_slider_description_' . $i );
							$designhubs_image_sliders= get_theme_mod( 'featured_image_sliders_' . $i);
							?>	
							<div class="item">
							  	<div class="hentry-inner">
